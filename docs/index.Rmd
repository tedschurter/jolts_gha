...
# 20240115 update: replaced previous prev_mnth code that incorrectly handled months greater than 9; new code is shorter, too.
prev_mnth <- paste0("M", match(max_mnth_ch, month.name)-1)
...
ggplot()+
  ...
  labs(
    ...
    subtitle = "<br>*Job opening:* A specific, full, part-time, permanent, or seasonal position that could be started within 30 days with active recruitment for the position from outside the offering establishment. *Total separations:* quits, layoffs and discharges, and other separations.",
